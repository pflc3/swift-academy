...
var Lessons: [Lesson] = [
    ...
    // Copy with isUnlocked: false
    Lesson(
        title: "Advanced Binary Operations",
        description: "Dive deeper into binary logic, bitwise operations, and practical use cases.",
        isUnlocked: false,
    ...
    Lesson(
        title: "Binary and Text Encoding",
        description: "Explore how binary enables text encoding formats such as UTF-8 and ASCII.",
        isUnlocked: false,
        difficulty: "Intermediate",
        duration: "35 minutes",
        videoID: nil,
